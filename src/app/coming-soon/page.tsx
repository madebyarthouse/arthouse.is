export default function ComingSoonPage() {
  return (
    <>
      ...
      <div className="bg-white/90 max-w-[95%] mx-auto relative z-20 p-5 lg:p-20 rounded-lg">
        <span className="shadow-lg mix-blend-darken border-entry-top bg-green-200 shadow-green-200" />
        <span className=" shadow-lg mix-blend-darken border-entry-bottom bg-red-200 shadow-red-200" />
        <span className="shadow-lg mix-blend-darken border-entry-right bg-amber-200 shadow-amber-200" />
        <span className="shadow-lg mix-blend-darken border-entry-left bg-purple-200 shadow-purple-200" />
